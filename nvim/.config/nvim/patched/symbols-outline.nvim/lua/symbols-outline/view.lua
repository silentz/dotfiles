...
function View:setup_view()
  local orig_win = vim.api.nvim_get_current_win() -- silentz
  ...
  -- create a split
  if config.options.win_open_command ~= nil then -- silentz
    vim.cmd(config.options.win_open_command)     -- silentz
  else                                           -- silentz
    vim.cmd(config.get_split_command())          -- silentz
  end                                            -- silentz
  ...
  vim.api.nvim_set_current_win(orig_win) -- silentz
end
