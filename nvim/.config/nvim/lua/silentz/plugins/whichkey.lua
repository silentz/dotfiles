return function()
    ...
    whichkey.setup({
        plugins = {
            ...
            spelling = {
                enabled = true,   -- enabling this will show WhichKey when
    ...
    if status_ok then
        ...
        presets.objects["ap"] = [[a parameter]]
        presets.objects["ip"] = [[inside parameter]]

        presets.motions["]p"] = [[next parameter (end of)]]
        presets.motions["]c"] = [[next class]]
        presets.motions["]f"] = [[next function]]

        presets.motions["[p"] = [[previous parameter]]
